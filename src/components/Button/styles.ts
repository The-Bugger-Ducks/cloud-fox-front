...
export const CustomButton = styled.button<ButtonProps>`
	...
	&:hover {
		color: ${({ theme, backgroundColor, fontColor }) =>
			backgroundColor === theme.colors.white ? fontColor : backgroundColor ?? theme.colors.primary};
		background: ${({ theme, backgroundColor, fontColor }) =>
			backgroundColor === theme.colors.white ? backgroundColor : fontColor ?? theme.colors.white};
		border: 1px solid
			${({ theme, backgroundColor }) =>
				backgroundColor === theme.colors.white ? theme.colors.primary : backgroundColor ?? theme.colors.primary};
